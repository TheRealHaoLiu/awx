...
class Migration(migrations.Migration):
    ...
    operations = [
        # Use DB-aware RenameIndex for event tables since their indexes only
        # exist on PostgreSQL (created by migration 0144's partition setup)
        ...
        # Regular RenameIndex for role tables - these indexes exist on both PostgreSQL and SQLite
